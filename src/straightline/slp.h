...
//int maxargs(A_stm) that tells the maximum number
...
//Exp -> (Stm, Exp)
    ...
    public:
        ...
        //here std::move means a reference to right value, which uses temporary value as a reference to increase the efficiency.
