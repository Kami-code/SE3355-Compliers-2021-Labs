...
​	This is [Kami-code](https://github.com/Kami-code)'s Complier class lab implementation. If you want to get more information, refer to the [course website](https://ipads.se.sjtu.edu.cn/courses/compilers/). If you want my notes, refer to [here](https://github.com/Kami-code/SE3355-Compliers-2021-Notes).

​	Here are some notes of my implementation from my blog.

| No.                                                         | Tasks                                                   |
| ----------------------------------------------------------- | ------------------------------------------------------- |
| [LAB2](https://www.kami-code.com/2021/10/17/complier-lab2/) | Write flex c++                                          |
| [LAB3](https://www.kami-code.com/2021/11/04/complier-lab3/) | Write Bison c++                                         |
| [LAB4](https://www.kami-code.com/2021/11/22/complier-lab4/) | Implement a type-checking module when scanning the AST. |
| [LAB5](https://www.kami-code.com/2021/12/14/complier-lab5/) | Implement a complete runnable tiger compiler.           |
| LAB6(NOTE TEMPORARILY NOT PROVIDED)                         | Implement register allocation.                          |
| LAB7(NOT IMPLEMENTED)                                       | Implement garbage collection.                           |

*Warning: The register allocation in lab6 is implemented not perfectly which only pass the test cases and will cause unintended loop unexpectedly. If I have time, I will fix it in future. Also, the [optional lab7](https://ipads.se.sjtu.edu.cn/courses/compilers/lab7.shtml) is not implemented for time's reason.
